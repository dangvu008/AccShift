...
import styles from '../styles/screens/weatherApiKeysScreen'
...
const WeatherApiKeysScreen = ({ navigation }) => {
  ...
  const handleClearCache = async () => {
    Alert.alert(
      t('Confirm Clear Cache'),
      t('Are you sure you want to clear all weather cache?'),
      [
        {
          text: t('Cancel'),
          style: 'cancel',
    ...
    <View style={[styles.keyItem, darkMode && styles.darkKeyItem]}>
      <View style={styles.keyInfo}>
        <View style={styles.keyHeader}>
          <Text style={[styles.keyText, darkMode && styles.darkText]}>
            {item.key}
          </Text>
          <View
            style={[
          ...
          >
            <Text style={styles.keyTypeBadgeText}>
      ...
      <View style={styles.keyActions}>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleRemoveKey(item.key)}
        >
          <Ionicons
            name="trash-outline"
            size={20}
    ...
    <View style={[styles.container, darkMode && styles.darkContainer]}>
      ...
      <View style={[styles.infoCard, darkMode && styles.darkCard]}>
        <Text style={[styles.infoTitle, darkMode && styles.darkText]}>
          {t('API Usage Information')}
        </Text>
        <Text style={[styles.infoText, darkMode && styles.darkSubtitle]}>
          {t('Free tier limits')}: 60 {t('requests/minute')}, 1,000,000{' '}
          {t('requests/month')}
        </Text>
        <Text style={[styles.infoText, darkMode && styles.darkSubtitle]}>
        ...
        <Text
          style={[styles.securityText, darkMode && styles.darkSecurityText]}
        >
          <Ionicons
            name="shield-checkmark"
            size={16}
            color={darkMode ? '#8a56ff' : '#27ae60'}
          />{' '}
      ...
      >
        <View style={styles.modalContainer}>
          ...
          >
            ...
            <Text
              style={[styles.securityNote, darkMode && styles.darkSubtitle]}
            >
              <Ionicons
...
// Styles moved to styles/screens/weatherApiKeysScreen.js
