...
/**
 * Tạo dữ liệu mẫu ca làm việc và trả về kết quả
 * @returns {Promise<Array>} Danh sách ca làm việc đã tạo
 */
export const createAndGetSampleShifts = async () => {
  try {
    // Tạo dữ liệu mẫu
    await createSampleShifts();
    
    // Đọc lại dữ liệu từ AsyncStorage
    ...
    console.error('Lỗi khi tạo và lấy dữ liệu mẫu ca làm việc:', error);
    return [];
  }
};

export default createSampleShifts;
