...
export const translations = {
  vi: {
    ...
    // Manual Update Modal keys - Vietnamese
    '-- Chọn trạng thái --': '-- Chọn trạng thái --',
    'Thời gian chấm công': 'Thời gian chấm công',
    'Vào:': 'Vào:',
    'Ra:': 'Ra:',
    ...
    'Vui lòng nhập thời gian check-out': 'Vui lòng nhập thời gian check-out',
    'Thời gian check-out phải sau thời gian check-in': 'Thời gian check-out phải sau thời gian check-in',
    'Thành công': 'Thành công',
    'Đã cập nhật trạng thái làm việc': 'Đã cập nhật trạng thái làm việc',
    'Không thể cập nhật trạng thái': 'Không thể cập nhật trạng thái',
    'Đã xảy ra lỗi khi cập nhật trạng thái': 'Đã xảy ra lỗi khi cập nhật trạng thái',
    'Đi muộn': 'Đi muộn',
    'Về sớm': 'Về sớm',
    'Đi muộn & về sớm': 'Đi muộn & về sớm',
    'Thiếu chấm công': 'Thiếu chấm công',
    'Nghỉ phép': 'Nghỉ phép',
    'Nghỉ bệnh': 'Nghỉ bệnh',
    'Nghỉ lễ': 'Nghỉ lễ',
    'Vắng không lý do': 'Vắng không lý do',
    'Ngày tương lai': 'Ngày tương lai',
  ...
  en: {
    ...
    'Thời gian vào': 'Check-in Time',
    'Thời gian ra': 'Check-out Time',
    'Đang tải dữ liệu...': 'Loading data...',
    'Không có ca làm việc': 'No work shift available',
    'Quên check-out': 'Forgot to check-out',

    // Manual Update Modal keys
    '-- Chọn trạng thái --': '-- Select Status --',
