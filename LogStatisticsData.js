...
const LogStatisticsData = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>Kiểm tra dữ liệu thống kê</Text>
      ...
      {loading ? (
        ...
        <ScrollView style={styles.resultsContainer}>
          ...
          <Text style={styles.sectionTitle}>Cách StatisticsScreen lấy dữ liệu:</Text>
          <Text style={styles.infoText}>1. StatisticsScreen gọi hàm loadStatistics() khi component được mount</Text>
          <Text style={styles.infoText}>2. loadStatistics() gọi hàm loadDailyWorkStatuses() để lấy dữ liệu từ AsyncStorage</Text>
          <Text style={styles.infoText}>3. loadDailyWorkStatuses() lấy các key bắt đầu bằng DAILY_WORK_STATUS_PREFIX</Text>
          <Text style={styles.infoText}>4. Dữ liệu được lấy theo batch để tránh quá tải</Text>
          <Text style={styles.infoText}>5. Sau khi lấy dữ liệu, calculateStatistics() được gọi để tính toán thống kê</Text>
          <Text style={styles.infoText}>6. Trong calculateStatistics(), các trường standardHoursScheduled, otHoursScheduled, sundayHoursScheduled, nightHoursScheduled được sử dụng</Text>
          <Text style={styles.infoText}>7. Nếu trạng thái là DU_CONG nhưng không có giá trị giờ làm, giá trị mặc định 8.0 giờ được sử dụng</Text>
...
export default LogStatisticsData;
